...
## v2.5 候选：图片 workspace 异常恢复
日期：2026-07-26

状态：Agent X 已从最新 `smalldata_test@71430810a90483090a7a47910bc018edd55f0671` 创建 `codeb/v2.5-image-workspace-recovery`，完成候选实现、本地轻量验证与两轮独立复审；尚待云端 full，正式版本仍为 `2.4`，未触碰 `main`。

...
## 历史记录
### v1.93 候选：Speech Run 取消与旧回调隔离
日期：2026-07-13

状态：Agent X 实现中，分支 `codeb/v1.93-speech-run-cancellation`，基于 `smalldata_test` merge `b374c19e99c784c5a933302a317a62572ba26355`。工程版本暂保持 `1.92`，待候选 exact-SHA 云端验收后收口为 `1.93`。未触碰 `main`。

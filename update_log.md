...
状态：Agent X 已完成核心候选实现、独立复审和 exact-SHA 云端 full 验证，工程正式版本收口为 `MARKETING_VERSION=2.1`；候选分支为 `codeb/v2.1-koharu-geometry-coverage`，尚待版本收口 SHA 的云端验证和 PR 合并，未触碰 `main`。

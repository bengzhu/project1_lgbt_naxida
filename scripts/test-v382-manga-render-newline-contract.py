...
class MangaRenderNewlineContractTests(unittest.TestCase):
    ...
    def test_version_and_koharu_route_follow_v381(self) -> None:
        ...
        self.assertIn(
            "scripts/test-v38(2-manga-render-newline|3-koharu-fit-budget|4-koharu-render-min-font|5-koharu-render-lock-min-font|6-koharu-render-output-ledger|7-koharu-render-output-action)-contract\\.py",
            self.workflow,
        )

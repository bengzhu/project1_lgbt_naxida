# 项目流程图
v3.109 普通图片 OCR 筛选切换到有结果时把 VoiceOver 焦点交给第一个可见结果行，空筛选仍使用既有可操作空态；该 View-only handoff 不新增 Store／持久化，不改变 OCR、翻译、renderer/export、探针报告或 Koharu active gate。候选 full `31064198524`、PR #173 fast `31064487760`、merge fast `31064532453` 均通过。

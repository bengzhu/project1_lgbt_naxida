...
flowchart TD
  ...
  ESC --> ETO["external TextBox orientation-aware shadow OCR<br/>bounded rotation + v1.92 凸四点 line polygon warp + v1.97 逐行失败隔离<br/>partial / fallback / 全失败与 arbitrary rotation 进入 blockers"]

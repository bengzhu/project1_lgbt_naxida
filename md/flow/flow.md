...
当前 v3.354 Japanese direction-confidence owner domain（研发中）：`vertical candidate/line owner geometry -> finite closed [0,1] direction confidence -> existing >=.25 ownership gate -> owner/ownerless fusion`；非法 `NaN/±∞` 与有限越界值不再取得 owner，合法 `.25`/`.45` 语义、16/8/4/24/12/48 上限、line/pixel/tile/frontier、OCR/layout、翻译 QA、取消和持久化边界不变。

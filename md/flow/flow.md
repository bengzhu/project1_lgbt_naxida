...
## 0. 一句话总览
v3.109 的普通图片 OCR 识别结果筛选在切换类别后，将 VoiceOver 焦点交给第一个可见结果行；隐藏选中清理、revision-scoped focus 和空筛选回退继续由 View 管理，不进入 Store、OCR、翻译、renderer/export 或 Koharu active gate。候选 full `31064198524`、PR #173 fast `31064487760`、merge fast `31064532453` 均通过。
